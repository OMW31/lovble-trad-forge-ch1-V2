...
## Implemented
- Structure pédagogique 1.1 → 1.6
- Scénarios interactifs avec correction immédiate
- Replays de marché déterministes
- 8 widgets fondamentaux déjà présents
- Shell avec sidebar sticky et tracking local
- Design system dark institutionnel déjà engagé
- Fondations backend pour profils / progression / reprise / évaluations
- Auth route initiale
...
- Certaines cartes encore trop simples pour le niveau visé
- Dépendance au tracking local seul
