# Visual A4 — Macro engine — terminal density

| Champ | Valeur |
|---|---|
| **Fichier** | `/academy/ch1/visuals/a4.webp` |
| **Statut** | INTÉGRÉ |
| **Rôle** | Macro engine — terminal density |
| **Placement** | 1.2 · groupe widgets macro (#macro-widgets) |
| **Variant `VisualLayer`** | `background` |
| **Opacité** | 0.14 |
| **Position** | `center top` |

## Effet & intégration
- **Animation** : fade-in opacity 0→1 (1.1s) au scroll, bidirectionnel.
