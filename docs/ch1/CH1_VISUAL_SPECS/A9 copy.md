# Visual A9 — Forecast horizon

| Champ | Valeur |
|---|---|
| **Fichier** | `/academy/ch1/visuals/a9.webp` |
| **Statut** | RÉSERVÉ |
| **Rôle** | Forecast horizon |
| **Placement** | 1.5 · intro prévisions (#previsions-concept) |
...
## Implémentation
```tsx
<VisualLayer src="/academy/ch1/visuals/a9.webp" alt="" variant="band" opacity={0.1} position="center" />
```
