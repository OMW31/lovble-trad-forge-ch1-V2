# Visual A6 — Corporate ledger

| Champ | Valeur |
|---|---|
| **Fichier** | `/academy/ch1/visuals/a6.webp` |
| **Statut** | RÉSERVÉ |
| **Rôle** | Corporate ledger |
| **Placement** | 1.3 · intro micro (#micro-concept) |
...
## Implémentation
```tsx
<VisualLayer src="/academy/ch1/visuals/a6.webp" alt="" variant="band" opacity={0.1} position="center" />
```
