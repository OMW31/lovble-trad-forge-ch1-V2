# Visual A13 — Intermarket web

| Champ | Valeur |
|---|---|
| **Fichier** | `/academy/ch1/visuals/a13.webp` |
| **Statut** | RÉSERVÉ |
| **Rôle** | Intermarket web |
| **Placement** | 1.2 · intermarket (#macro-widgets) |
...
## Implémentation
```tsx
<VisualLayer src="/academy/ch1/visuals/a13.webp" alt="" variant="band" opacity={0.08} position="center" />
```
